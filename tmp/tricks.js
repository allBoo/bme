{
	...
	wis_water_shield07: {name: 'wis_water_shield07', caption: 'Иней [7]', description: 'Вы получаете на 25% меньше урона 4 последующих размена.', school: 'water',
		required: {level:7,intellect:40,watermagicskill:7},
		consumes: {mana:89}
	},
	wis_water_shield08: {name: 'wis_water_shield08', caption: 'Иней [8]', description: 'Вы получаете на 25% меньше урона 4 последующих размена, <br>атакующий оружием получает уязвимость к магии воды, не подвержен шоку.', school: 'water',
		required: {level:8,intellect:50,watermagicskill:8},
		consumes: {mana:133}
	},
	wis_water_shield09: {name: 'wis_water_shield09', caption: 'Иней [9]', description: 'Вы получаете на 25% меньше урона 4 последующих размена, <br>атакующий оружием получает уязвимость к магии воды и часть поглощённого урона, не подвержен шоку.', school: 'water',
		required: {level:9,intellect:60,watermagicskill:9},
		consumes: {mana:195}
	},
