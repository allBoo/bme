...
-define(log_hit_tpl1, ?log_start ++ ?log_date ++ ?log_unit ++ " ~ts, ~ts ~ts " ++ ?log_unit ++ ", ~ts, ~ts ~ts ~ts ~ts " ++ ?log_damage ++ ?log_end).
...
-define(log_hit_tpl2, ?log_start ++ ?log_date ++ ?log_unit ++ " ~ts, ~ts ~ts " ++ ?log_unit ++ ", ~ts, ~ts ~ts ~ts ~ts ~ts ~ts " ++ ?log_damage ++ ?log_end).
...
-define(log_crit_tpl, ?log_start ++ ?log_date ++ ?log_unit ++ " ~ts, ~ts ~ts " ++ ?log_unit ++ ", ~ts, ~ts " ++ ?log_crit_damage ++ ?log_end).
