...
%% результат размена
-record(b_damage, {damage      = 0 :: non_neg_integer(),   %% кол-во нанесенного урона
                   loss        = 0 :: integer(),           %% кол-во полученного урона (может быть отрицательным, т.е. повышение ХП)
                   loss_mana   = 0 :: integer(),           %% кол-во потраченной маны (может быть отрицательным, т.е. повышение маны)
