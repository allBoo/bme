...
-record(u_mf, {crit    = 0.0,   %% крит (мф от шмота, от оружия добавляется отдельно)
               ucrit   = 0.0,   %% анти-крит
               ...
               acounter = 0.0,   %% абсолютный контр-удар
               parry   = 0.0,   %% парир
...
-record(u_weapon, {damage      = #'d_value'{},       %% урон оружия
...
-record(u_damage, {base = #'d_value'{},       %% базовый урон
				   left = #'u_weapon'{},
				   right = #'u_weapon'{}}).
...
-record(u_wpower, {general = 0.0,  %% мощь общей магии
                   ...
                   manaconsumption = 0.0  %% Уменьшение расхода маны
       }).
