...
ExUser1 = #user{
	...
	damage = #'u_damage'{
		left = #'u_weapon_damage'{
			damage = #'d_value'{10, 5},  %% базовый урон
			crit   = 100.0,              %% мф крита
	...
	armor  = #'u_armor'{
		head   = #'d_value'{14, 10},    %% броня головы
		chest  = #'d_value'{8, 24},     %% броня груди
		paunch = #'d_value'{11, 29},    %% броня живота
		belt   = #'d_value'{6, 24},     %% броня пояса
		legs   = #'d_value'{9, 23}      %% броня ног
	},
